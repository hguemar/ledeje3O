...
- Au moins deux tests unitaires pour la fonction summarize.
- Un test fonctionnel pour entrer un article (ne pas oublier de le supprimer de la base à la fin du test :-) )
